...
const SLUG = 'u-z30c';
const OLD_FILE_ID = 171; // u-z30c.webp
const NEW_IMAGE_PATH = path.join(ASTRO_DIR, 'public', 'images', 'u-z30c', 'u-z30c-new.png');
const LOCAL_OLD = path.join(ASTRO_DIR, 'public', 'images', 'u-z30c.webp');

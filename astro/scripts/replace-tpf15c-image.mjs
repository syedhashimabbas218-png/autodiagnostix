...
const SLUG = 'liberty-tpf-15c';
const OLD_FILE_ID = 174; // liberty-tpf-15c.webp
const NEW_IMAGE_PATH = path.join(ASTRO_DIR, 'public', 'images', 'tpf-15c', 'tpf-15c-new.png');
const LOCAL_OLD = path.join(ASTRO_DIR, 'public', 'images', 'liberty-tpf-15c.webp');

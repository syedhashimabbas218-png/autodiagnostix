...
const SLUG = 'liberty-fr-6105';
const OLD_FILE_ID = 172; // liberty-fr-6105.webp
const NEW_IMAGE_PATH = path.join(ASTRO_DIR, 'public', 'images', 'fr-6105', 'fr-6105-new.png');
const LOCAL_OLD = path.join(ASTRO_DIR, 'public', 'images', 'liberty-fr-6105.webp');
...
async function main() {
  ...
  if (fs.existsSync(LOCAL_OLD)) {
    fs.unlinkSync(LOCAL_OLD);
    console.log(`  ✓ Deleted local file: ${LOCAL_OLD}`);
  }

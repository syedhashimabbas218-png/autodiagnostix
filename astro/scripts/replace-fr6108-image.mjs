...
const SLUG = 'liberty-fr-6108';
const OLD_FILE_ID = 173; // liberty-fr-6108.webp
const NEW_IMAGE_PATH = path.join(ASTRO_DIR, 'public', 'images', 'fr-6108', 'fr-6108-new.png');
const LOCAL_OLD = path.join(ASTRO_DIR, 'public', 'images', 'liberty-fr-6108.webp');
